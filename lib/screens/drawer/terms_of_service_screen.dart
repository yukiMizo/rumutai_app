            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _indentedText(
                      "a.", "ユーザーは、「HR対抗」アプリ（以下、本アプリ)を個人的な目的で利用できます。"),
                  ...
                  _indentedText("f.",
                      "ユーザーが、アプリ内で提供した個人情報については「プライバシーポリシー」に基づいて扱われるものとします。"),
                  const SizedBox(height: 5),
                  const Text(
                    "2. 知的財産権",
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ...
                  _indentedText("b.",
                      "ユーザーは、アプリ内で表示される情報やコンテンツを個人的な目的で利用することができますが、これらの情報やコンテンツを商業的な目的で利用することはできません。"),
                  const SizedBox(height: 5),
                  const Text(
                    "3. 免責事項",
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ...
                  _indentedText("c.", "アプリの利用によって生じた損害について、著作者は責任を負いません。"),
                  const SizedBox(height: 5),
                  const Text(
                    "4. 利用規約の変更",
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ...
                  _indentedText("b.", "利用規約が変更された場合、アプリでユーザーへ通知します。"),
